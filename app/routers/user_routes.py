...
# NOTE: Username and password validation is enforced at the schema level (see app/schemas/user_schemas.py).
...
# PATCH/PUT /users/{user_id} - Updates user profile fields. Handles edge cases for bio/profile_picture_url.
